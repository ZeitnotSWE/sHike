...
public class Weather {
	...
	public void setForecastById(int forecastId) {
		this.forecast = ForecastType.getById(forecastId);
	}
	...
	/**
	 * Enum che indica il tipo di condizioni meteo previste. I codici indicati nelle
	 * condizioni si riferiscono agli identificatori di <a
	 * href="http://openweathermap.org/weather-conditions">OpenWeatherMap</a>
	 */
	public enum ForecastType {
		THUNDERSTORM("tempesta", 200, 232), RAIN("pioggia", 300, 531), SNOW("neve", 600, 622), FOG(
				"nebbia", 701, 781), CLEAR("sereno", 800, 800), CLOUDS("nuvoloso", 801, 804),
